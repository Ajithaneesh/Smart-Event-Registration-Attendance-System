        ...
        <main className="flex-1">
          <AnimatePresence mode="wait">
            <Routes location={location} key={location.pathname}>
              ...
              {/* Admin Routes */}
              <Route path="/admin" element={<ProtectedRoute adminOnly><AnimatedRoute><AdminDashboard /></AnimatedRoute></ProtectedRoute>} />
              <Route path="/admin/scanner" element={<ProtectedRoute adminOnly><AnimatedRoute><Scanner /></AnimatedRoute></ProtectedRoute>} />
              <Route path="/admin/create-event" element={<ProtectedRoute adminOnly><AnimatedRoute><CreateEvent /></AnimatedRoute></ProtectedRoute>} />
              <Route path="/admin/analytics" element={<ProtectedRoute adminOnly><AnimatedRoute><AdminAnalytics /></AnimatedRoute></ProtectedRoute>} />
